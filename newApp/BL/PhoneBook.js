...
BL.PhoneBook = (function () {

    function PhoneBook() {
        this.root = new BL.Group('Root', false, 0);
    ...
    PhoneBook.prototype.addContact = function (firstName, lastName, phoneNumbers, callback) {
        var newContact =
            new BL.Contact(firstName, lastName, phoneNumbers, this.currentGroup, BL.helpers.generateId());
    ...
    PhoneBook.prototype.addGroup = function (name) {
        var newGroup = new BL.Group(name, this.currentGroup, BL.helpers.generateId());
