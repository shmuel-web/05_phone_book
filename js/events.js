...
app.eventListeners = (function () {
    ...
    var addEmailBtn = $('#add-email');
    var addLocationBtn = $('#add-address');
    var deleteItemBtn = $('#delete-btn');
    var editItemBtn = $('#edit-btn');
